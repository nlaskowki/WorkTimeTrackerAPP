...
/**
 * Created by Maximus on 2/6/2018.
 *
 * Used code from video https://www.youtube.com/watch?v=ybKgq6qqTeA&t=629s to create clock.
 */
...
public class AnalogClock extends View {
    ...
    private int handTruncation, hourHandTrunction = 0;
    ...
    private void drawHand(Canvas canvas, double loc, boolean isHour){
        ...
        int handRadius = isHour ? radius - handTruncation - hourHandTrunction : radius - handTruncation;
    ...
    private void drawNumeral(Canvas canvas) {
        paint.setTextSize(getResources().getDimensionPixelSize(R.dimen.clocktext));
